...
A transducer, by our assumption, is deterministic and causal, so that $T[x](t)$ is a deterministic function of the signal we have seen so far, and so it is a deterministic function of $c_0(t), c_1(t), c_2(t), ...$. Note carefully that it is determined by $c_0(t), c_1(t), c_2(t), ...$ *at this very instant* $t$. It does not need the values of $c_0(t'), c_1(t'), c_2(t'), ...$ at any $t' \neq t$. We write it as follows:
